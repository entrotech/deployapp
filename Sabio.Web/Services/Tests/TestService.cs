...
namespace Sabio.Web.Requests.Tests
{

    public class TestService : BaseService, Sabio.Web.Requests.Tests.ITestService
    {
        ...
        public static List<TestEmployee> GetEmployees(List<int> ids)
        {
            ...
            DataProvider.ExecuteCmd(GetConnection, "dbo.TestEmployees_SelectByIds"
               , inputParamMapper: delegate(SqlParameterCollection paramCollection)
               {
        ...
        internal static List<Domain.Tests.TestEmployee> GetEmployees()
        {
            ...
            DataProvider.ExecuteCmd(GetConnection, "dbo.TestEmployees_Select"
               , inputParamMapper: null
               , map: delegate(IDataReader reader, short set)
               {
                   TestEmployee p = new TestEmployee();
