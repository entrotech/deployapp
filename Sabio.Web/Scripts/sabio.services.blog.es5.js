...
sabio.services.blog.search = function (searchStr, onSuccess, onError) {

	var url = "/api/blogs/search?SearchStr=" + searchStr;
	var settings = {
		cache: false,
		success: onSuccess,
		error: onError,
...
sabio.services.blog.deletePhoto = function (id, onSuccess, onError) {
...
sabio.services.blog.getAllByUserId = function (onSuccess, onError) {
	var url = "/api/blogs/user";
	var settings = {
		cache: false,
		contentType: "application/json; charset=UTF-8",
		dataType: "json",
